...
/*
 * Tertiary Processor-based capabilities from SDM Vol-3C, Table 24.8
*/
...
/*
 * VM-Exit Controls capabilities from SDM Vol-3C, Table 24.13
 */
...
/*
 *  VM-Entry Controls capabilities from SDM Vol-3C, Table 24.15
 */
